...
python3 << EOF_ | singularity exec docker://ghcr.io/mmore500/multilevel-selection-concept@sha256:409cbf83d5365fd7acb82b90fdf76fdbbc05cc5e1ea288fd4745b3883821a589 python3 -m pylib.cli.run_volzscreen
