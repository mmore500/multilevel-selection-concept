...
SHA="573552a4e192a040a1ad13fd675dbf12b977bacc8a1ec1c7a268015988402e90"
echo "SHA ${SHA}"
...
refphylos = "https://osf.io/mr7kv/download"
...
assert len(replicates) == 24, f"expected 24 replicates, got {len(replicates)}"
