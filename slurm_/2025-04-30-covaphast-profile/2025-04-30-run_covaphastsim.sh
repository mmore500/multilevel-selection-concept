...
python3 << EOF_ | singularity exec docker://ghcr.io/mmore500/multilevel-selection-concept@sha256:02c5c63f684cfc13bfd423ef97e6ac053a1bcd3b4d01c350e5481029c4179c89 python3 -m pylib.cli.run_covaphastsim
...
cfg = f"""
cfg_num_mut_sites: 1
cfg_p_wt_to_mut: {2.74e-6}  # should divide by 3 possible alt nucleotides?
