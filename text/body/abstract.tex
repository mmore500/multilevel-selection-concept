...
To test the robustness of this methodology, we conduct additional experiments incorporating extrinsic, time-varying environmental changes and adaptive turnover in population compositions, and find generally screen performance remains generally consistent with baseline conditions.
